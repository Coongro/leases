/**
 * Inquilinos — datos y estado (generado por el Builder de Vistas).
 *
...
export function useInquilinosView() {
  ...
  const COLUMNS: {
    ...
    { key: 'current_property', label: 'Alquila', emptyLabel: '—' },
    { key: 'current_unit', label: 'Unidad', emptyLabel: '—' },
    {
      key: 'is_current',
      label: 'Estado',
      display: 'pill',
      values: [
        { value: 'true', label: 'Con contrato vigente', tone: 'success', icon: 'CircleCheck' },
        { value: 'false', label: 'Sin contrato', tone: 'outline', icon: 'CircleSlash' },
      ],
    },
  ];
