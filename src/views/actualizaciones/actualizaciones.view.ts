/**
 * Actualizaciones — composición y render (generado por el Builder de Vistas).
 *
    ...
    h(
      ...
      h(UI.DataTable, {
        ...
        emptyState: {
          ...
          description:
            'Cuando un contrato cumpla su período, la actualización aparece acá con el factor ya calculado.',
            ...
            h(
              ...
              h(
                ...
                h(
                  ...
                  metric('k1', 'sub', 'esperan tu confirmación')
                )
              )
            )
          ),
              ...
              h(
                ...
                h(
                  ...
                  h(
                    ...
                    h(UI.DynamicIcon, { icon: 'Calculator', size: 17 })
                  ),
                  h(
                    'span',
                    {
                ...
                h(
                  'div',
                  { style: { fontSize: '12px', color: 'var(--cg-text-muted)', marginTop: '2px' } },
                  metric('k2', 'sub', 'si aplicás todas')
                )
              )
            )
          ),
